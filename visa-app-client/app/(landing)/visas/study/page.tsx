  ...
  return (
    <div className="bg-white min-h-screen font-sans text-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold text-[#00264d] mb-8 text-center border-b pb-4">Study in {countryName}</h1>
        ...
        <div className="flex flex-col gap-12 text-left">
          <section id="information" className="scroll-mt-6">
            ...
            <p className="text-gray-700 leading-relaxed">
              This visa allows you to stay in {countryName} to study full-time in a recognised education institution. 
              Find out about the steps you need to take before applying and what requirements you must meet to ensure a successful application.
            </p>
          </section>
          ...
          <section id="details" className="scroll-mt-6">
            ...
            <ul className="list-disc pl-5 text-gray-700 space-y-2">
              <li><strong>Stay:</strong> Up to 5 years and in line with your enrolment.</li>
              <li><strong>Cost:</strong> Varies depending on the applicant&apos;s circumstances.</li>
              <li><strong>With this visa you can:</strong> Participate in an eligible course of study, bring family members, and work extra hours in certain sectors.</li>
            </ul>
          </section>
          ...
          <section id="health" className="scroll-mt-6">
            ...
            <p className="text-gray-700 leading-relaxed">
              You, and any family members who apply for the visa with you, must meet our health requirement. In some circumstances, family members who are not coming to {countryName} might also need to meet our health requirement.
