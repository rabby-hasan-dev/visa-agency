  ...
  return (
    <div className="bg-white min-h-screen font-sans text-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold text-[#00264d] mb-8 text-center border-b pb-4">Visit {countryName}</h1>
        ...
        <div className="flex flex-col gap-12 text-left">
          <section id="information" className="scroll-mt-6">
            ...
            <p className="text-gray-700 leading-relaxed">
              This visa lets you visit {countryName} as a tourist, to see family and friends or for purposes other than business or medical treatment.
            </p>
          </section>
          ...
          <section id="details" className="scroll-mt-6">
            ...
            <ul className="list-disc pl-5 text-gray-700 space-y-2">
              <li><strong>Stay:</strong> Up to 3, 6 or 12 months.</li>
              <li><strong>Cost:</strong> Varies depending on the applicant&apos;s circumstances and location when applying.</li>
              <li><strong>With this visa you can:</strong> Visit family or friends, be there as a tourist, for a cruise, or for any purpose except business or medical treatment.</li>
            </ul>
          </section>
          ...
          <section id="health" className="scroll-mt-6">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              You might need to organise health examinations to prove you meet these standards depending on your length of stay and country of origin.
            </p>
          </section>
          ...
          <section id="pricing" className="scroll-mt-6">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              The visa application charge can vary. Extra costs may apply for each family member who applies with you and for health checks.
            </p>
